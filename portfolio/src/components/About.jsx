  ...
  return (
    <>
      <div className="flex items-center justify-center w-full h-full">
        <div className="flex flex-col lg:flex-row justify-center gap-4 items-stretch w-5/6 lg:w-2/3 my-12">
          <div className="w-full lg:w-1/2 bg-white p-12 rounded-xl shadow-2xl border border-black">
            <h1 className="text-lg font-bold underline mb-3">About Me</h1>
            <p className="text-sm lg:text-base">
              I am a developer based in the UK (England) 📍.
            </p>
            <br />
            <p className="text-sm lg:text-base">
          ...
          <div className="bg-white p-12 rounded-xl shadow-2xl border border-black">
